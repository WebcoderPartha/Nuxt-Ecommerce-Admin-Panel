<template>
<div class="bg-white shadow-sm shadow-slate-200 fixed top-0 w-full z-10 hidden md:block px-2">
            <header class="max-w-[1200px] mx-auto">
                <div class="md:flex justify-between items-center pt-6">
                    ...
                    <div class="flex gap-2 justify-center item-center">
                        ...
                        <NuxtLink to="/cart" class="text-stone-950 pt-1 text-xl hover:rounded-md cursor-pointer relative h-full">
                        ...
                        <NuxtLink v-if="!isAuthenticated" to="/auth/login" class="h-full text-stone-950 px px-2 py-2 hover:rounded-md cursor-pointer">
                ...
                <div class="MenuContainer pt-4 pb-3">
                    <ul class="flex gap-3 text-stone-950 font-semibold justify-center md:justify-normal">
                        ...
                        <li class="py-2 px-2"><NuxtLink to="/shop">Shop</NuxtLink></li>
