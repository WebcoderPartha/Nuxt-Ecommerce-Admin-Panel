        ...
        <div class=" bg-gray-500 px-3 py-4 flex flex-col w-[600px]">
            ...
            <div class=" pb-4">
                <form action="">
                    ...
                    <h4>Order ID : {{ orderdata?.order_status }}</h4>
                    <div class=" flex-col flex py-2">
                         <label for="status" class="text-xl font-semibold">Order Status</label>
                         
                         <select @change="orderStatusChange" id="status"  class="w-80 bg-gray-900 mx-auto rounded-md px-3 py-2 border-gray-300 text-sm focus:ring-blue-500 focus:border-blue-500 block p-2.5 text-blue-300 focus:outline-none cursor-pointer">
